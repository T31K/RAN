...
public:
	...
	BOOL InsertItem ( const SITEMCUSTOM &ItemCustom, const WORD wPosX, const WORD wPosY, bool bLOAD=false );	//	�ε�(Assign) �ÿ��� ���� ���ΰ� ������ �־���.
...
public:
	...
	bool GetPileItem ( const SNATIVEID _sNID, WORD &wPosX, WORD &wPosY );	//	��ħ ���� ���� ��ŭ ���� �ִ� ���� ��ȯ.
